...
sub define_fmt
{
	...
	} elsif( $configuration{"variation"} eq "rgf_spring2020" || $configuration{"variation"} eq "slim" || $configuration{"variation"} eq "rgm_fall2021" ) {
...
sub make_fmt
{
	...
	if( $configuration{"variation"} eq "rgf_spring2020" || $configuration{"variation"} eq "slim" || $configuration{"variation"} eq "rgm_fall2021" ) {
